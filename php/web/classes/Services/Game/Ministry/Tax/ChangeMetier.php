...
class ChangeMetier extends \Services\Base\Minister {
    ...
    public function addMetierTax(&$fix, &$var, &$table) {
        $tax = \Model\Game\Tax\Metier::GetFromCityAndMetier($this->city, $this->metier) ;
    ...
    public function getMessage() {
        ...
        $res .= \I18n::CHANGE_TAX_METIER_MESSAGE($this->metier->getName()) ;
