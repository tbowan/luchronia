...
class CharacteristicPrimary extends \Answer\Widget\Misc\Section  {
    
    private function getPrimaryTable(\Model\Game\Character $c) {
        ...
        foreach (\Model\Game\Characteristic::GetPrimary() as $cha) {
    ...
    public function __construct(\Model\Game\Character $c, $classes) {
        ...
        parent::__construct(\I18n::PRIMARY_CHARACTERISTICS(), \I18n::HELP_MSG("/Help/Characteristic"), "", $this->getPrimaryTable($c), $classes) ;
    }
