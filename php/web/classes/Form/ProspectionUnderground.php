...
class ProspectionUnderground extends \Quantyl\Form\Model\Select{
    ...
    public function initChoices() {
        ...
        foreach (\Model\Game\Ressource\Ecosystem::GetFromBiome($biome) as $ecosystem) {
            $item = $ecosystem->item ;
            if ($ecosystem->biome == null && ! \Model\Game\Ressource\Prospection::HasBeenProspected($this->_char, $this->_char->position, $item)) {
